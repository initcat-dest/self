 ...
 * @date 2020/6/4
 */
public class ZooKeeperDistributedLock01 implements Lock, Watcher {
    ...
    public ZooKeeperDistributedLock01() {
        try {
            //创建zk的链接
        ...
        for (int i = 0; i < 10; i++) {
            new Thread(() -> {
                try {
                    ...
                    ZooKeeperDistributedLock01 dispathLock = new ZooKeeperDistributedLock01();
